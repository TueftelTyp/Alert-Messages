        ...
        public void showAlert(string msgTitle, string msgText, enmType type)
        {
            ...
            switch(type)
            {
                case enmType.Success:
                    this.alertPicture.Image = Resources.success;
                    this.BackColor = Color.SeaGreen;
                    break;
                case enmType.Error:
                    this.alertPicture.Image = Resources.error;
                    this.BackColor = Color.DarkRed;
                    break;
                case enmType.Info:
                    this.alertPicture.Image = Resources.info;
                    this.BackColor = Color.RoyalBlue;
                    break;
                case enmType.Warning:
                    this.alertPicture.Image = Resources.warning;
